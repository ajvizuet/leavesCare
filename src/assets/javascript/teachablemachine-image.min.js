...
var tmImage = (function (t) {
  ...
  function (t, e, n) {
    ...
    var l = function (t) {
        return (
          (t.packageVersion = t.packageVersion || c.version),
      ...
      p = function (t) {
        ...
        if (((t.version = t.version || 1), 1 === t.version)) {
          (t.alpha = t.alpha || 0.25),
            (t.alpha = f(t.version, t.alpha)),
            console.log(
              "Loading mobilenet " + t.version + " and alpha " + t.alpha
            );
        ...
        if (2 === t.version)
          return (
            ...
            [
              "https://storage.googleapis.com/teachable-machine-models/mobilenet_v2_weights_tf_dim_ordering_tf_kernels_" +
                t.alpha.toFixed(2) +
                "_" +
                e.IMAGE_SIZE +
                "_no_top/model.json",
                  ...
                  [
                    ...
                    i.tidy(function () {
                      ...
                      var i = new Float32Array(n),
                        a = new Int32Array(n);
                      for (o = 0; o < n; o++)
                        (i[o] = e[o].value), (a[o] = e[o].index);
                      var s = [];
                      for (o = 0; o < a.length; o++)
                        s.push({ className: t[a[o]], probability: i[o] });
                      return s;
                    }),
                  ]
                );
            ...
            r(this, void 0, void 0, function () {
              ...
              return o(this, function (o) {
                switch (o.label) {
                  ...
                  case 1:
                    for (l = o.sent(), f = [], p = 0; p < l.length; p++)
                      f.push({
        ...
        return r(this, void 0, void 0, function () {
          ...
          return o(this, function (o) {
            switch (o.label) {
              case 0:
                return (
                  (e = p(t)), (n = e[0]), (r = e[1]), [4, i.loadLayersModel(n)]
                );
              case 1:
                return (
                  (a = o.sent()),
                  t && 1 === t.version
                    ? ((s = a.getLayer(r)),
                      (u = i.model({ inputs: a.inputs, outputs: s.output })),
                      (c = i.sequential()).add(u),
                      c.add(i.layers.flatten()),
                      [2, c])
                    : ((s = a.getLayer(r)),
                      (u = i.model({ inputs: a.inputs, outputs: s.output })),
                      (c = i.sequential()).add(u),
                      c.add(i.layers.globalAveragePooling2d({})),
                      [2, c])
                );
            }
          });
    ...
    (e.resize = o),
      ...
      (e.cropTo = function (t, e, n, o) {
        ...
        t instanceof HTMLVideoElement &&
          ((i = t.videoWidth), (a = t.videoHeight));
        ...
        return (
          p.drawImage(t, -1 * ~~(l / 2), -1 * ~~(f / 2), u, c),
          n && (p.scale(-1, 1), p.drawImage(o, -1 * u, 0)),
          o
        );
      });
  },
    ...
    var d = (function (t) {
      ...
      return (
        ...
        (e.prototype.addExample = function (t, e) {
          return i(this, void 0, void 0, function () {
            ...
            return a(this, function (i) {
              ...
              return (
                (n =
                  "object" == typeof (a = e).dataId && "object" === a.shape
                    ? e
                    : c.capture(e)),
        ...
        (e.prototype.convertToTfDataset = function () {
            ...
            r = function (t) {
              var r,
                ...
                s =
                  ((r = t),
                  (i = o.numClasses),
                  ((a = new Array(i).fill(0))[r] = 1),
                  a),
                u = o.examples[t].length,
                c = u - Math.ceil(0.15 * u),
                l = o.examples[t].slice(0, c).map(function (t) {
                  return { data: t, label: s };
                }),
          ...
          return {
            trainDataset: s.data.zip({ xs: i, ys: u }),
            validationDataset: s.data.zip({ xs: a, ys: c }),
          };
        }),
              ...
              return a(this, function (a) {
                switch (a.label) {
                  case 0:
                    if (
                      ...
                      (e.onTrainEnd = function (t) {
                        h.__stopTrainingResolve &&
                          (h.__stopTrainingResolve(),
                          (h.__stopTrainingResolve = null)),
                          n(t);
                      }),
                      this.isPrepared || this.prepare(),
                      (r = this.getLabels().length),
                      u.util.assert(r === this.numClasses, function () {
                        return (
                          "Can not train, has " +
                          r +
                          " labels and " +
                      ...
                      (i = s.util.sizeFromShape(o)),
                      (c = this.seed
                        ? s.initializers.varianceScaling({ seed: 3.14 })
                        : s.initializers.varianceScaling({})),
                      (this.trainingModel = s.sequential({
                        layers: [
                          s.layers.dense({
                            inputShape: [i],
                            units: t.denseUnits,
                    ...
                    return (
                      (f = this.trainDataset.batch(t.batchSize)),
                      (p = this.validationDataset.batch(t.batchSize)),
                      [
                        4,
                        this.trainingModel.fitDataset(f, {
                          epochs: t.epochs,
                          validationData: p,
                          callbacks: e,
                        }),
                  ...
                  case 1:
                    return (
                      a.sent(),
                      (d = s.sequential()).add(this.truncatedModel),
          ...
          return i(this, void 0, void 0, function () {
            ...
            return a(this, function (_) {
              switch (_.label) {
                ...
                case 2:
                  (l = _.sent()), (f = []), (p = []), (w = 0), (_.label = 3);
                case 3:
                  return w < r ? [4, c.next()] : [3, 7];
                case 4:
                  return (
                    (d = _.sent()),
                    (h = this.trainingModel.predict(d.value)),
                    (v = h.argMax(1)),
                    f.push(v),
                    [4, l.next()]
                  );
                ...
                case 6:
                  return w++, [3, 3];
                case 7:
                  if (((m = s.concat(p)), (g = s.concat(f)), 1 !== r))
                    for (w = 0; w < f.length; w++)
                      f[w].dispose(), p[w].dispose();
                  return [2, { reference: m, predictions: g }];
              }
            });
          });
        }),
  ...
  function (t, e, n) {
    ...
    !(function (o, i) {
      ...
      function y(t) {
        ...
        for (n || (t = [n++]); o < u; ) a[o] = o++;
        for (o = 0; o < u; o++)
          (a[o] = a[(i = h & (i + t[o % n] + (e = a[o])))]), (a[i] = e);
        (r.g = function (t) {
          for (var e, n = 0, o = r.i, i = r.j, a = r.S; t--; )
            (e = a[(o = h & (o + 1))]),
              (n = n * u + a[h & ((a[o] = a[(i = h & (i + e))]) + (a[i] = e))]);
      ...
      l = (function () {
        ...
        return (
          (t.prototype.getWebcam = function (t) {
            ...
            var n = (function (t) {
                return (
                  (t.facingMode = t.facingMode || s),
                  (t.frameRate = t.frameRate || u),
                  (t.aspectRatio = t.aspectRatio || c),
                  t
                );
              })(t),
              r = document.createElement("video");
            return window.navigator.mediaDevices
              .getUserMedia({ video: n })
              .then(
                function (t) {
                  return (
                    (r.srcObject = t),
          ...
          (t.prototype.renderCameraToCanvas = function () {
            if (this.canvas && this.webcam) {
              ...
              this.flip
                ? (t.save(),
                  t.scale(-1, 1),
                  t.drawImage(this.webcam, -this.webcam.width, 0),
                  t.restore())
                : t.drawImage(this.webcam, 0, 0);
            }
          }),
          r([a.default], t.prototype, "getWebcam", null),
          r([a.default], t.prototype, "setup", null),
          r([a.default], t.prototype, "play", null),
          r([a.default], t.prototype, "pause", null),
          r([a.default], t.prototype, "stop", null),
          r([a.default], t.prototype, "update", null),
          r([a.default], t.prototype, "stopStreamedVideo", null),
          r([a.default], t.prototype, "renderCameraToCanvas", null),
          t
        );
      })();
    e.Webcam = l;
